		 ...
		 text-5xl mt-10 p-5"
          >
            In Life, It's Not Where You Go, It's Who You Travel With
					...
					<hr className="w-64 h-1 mx-auto bg-almost-white border-0 rounded md:my-10 dark:bg-gray-700" />
          <div className="">
            ...
            <hr className="w-64 h-0.5 mx-auto bg-almost-white border-0 rounded md:my-10 dark:bg-gray-700 opacity-30" />
